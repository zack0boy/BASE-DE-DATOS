...
declare class NgbInputDatepicker implements OnChanges, OnDestroy, ControlValueAccessor, Validator {
     ...
     */
    placement: _ng_bootstrap_ng_bootstrap.PlacementArray;
    /**
...
export type { DayTemplateContext, NgbDateStruct, NgbDatepickerNavigateEvent, NgbDatepickerState, NgbModalOptions, NgbModalUpdatableOptions, NgbNavChangeEvent, NgbNavContentContext, NgbOffcanvasOptions, NgbPeriod, NgbScrollSpyProcessChanges, NgbSlideEvent, NgbTimeStruct, NgbToastOptions, NgbTypeaheadSelectItemEvent, Placement, PlacementArray };
